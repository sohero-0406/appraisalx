...
public class CarInfoController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "saveBaseInfoOne")
    @ResponseBody
    public CommonResult saveBaseInfoOne(@Validated BaseInfoOneVO vo) {
        DelegateUser delegateUser = new DelegateUser();
        CarInfo carInfo = new CarInfo();
        try {
            BeanUtils.copyProperties(delegateUser, vo.getDelegateUser());
            BeanUtils.copyProperties(carInfo, vo.getCarInfo());
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return
     */
    @RequestMapping(value = "saveBaseInfoThree")
    @ResponseBody
    public CommonResult saveBaseInfoThree(@Validated BaseInfoThreeVO vo) {
        DelegateUser delegateUser = new DelegateUser();
        CarInfo carInfo = new CarInfo();
        try {
            BeanUtils.copyProperties(delegateUser, vo.getDelegateUser());
